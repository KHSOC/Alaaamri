...
window.TRAINING_COURSES = [
  {
    ...
    modules:[
      {
        id:"pa-01",title:"الأسس الأمنية وZero Trust",duration:"70 دقيقة",summary:"ابدأ باللغة المشتركة للأمن: الهوية والثقة والأصول والمخاطر، ثم حوّل المبادئ إلى قرارات وصول قابلة للقياس.",
        lessons:[
      ...
      {
        id:"pa-02",title:"التهديدات ودورة الهجوم",duration:"80 دقيقة",summary:"تعلّم قراءة الهجوم كسلسلة مراحل بدل حدث منفصل، وربط الأدلة بالتكتيكات والتقنيات المناسبة.",
        lessons:[
      ...
      {
        id:"pa-03",title:"نماذج الشبكات والترافيك",duration:"85 دقيقة",summary:"راجع OSI وTCP/IP وPDU ودورة TCP، ثم افهم لماذا يعمل NGFW عبر الطبقات وليس على رقم المنفذ فقط.",
        lessons:[
      ...
      {
        id:"pa-04",title:"IP وRouting وNAT",duration:"95 دقيقة",summary:"ابنِ أساسًا صلبًا في العنونة واختيار المسار وترجمة العناوين، مع التركيز على ترتيب المعالجة في PAN-OS.",
        lessons:[
      ...
      {
        id:"pa-05",title:"LAN وWAN وSD-WAN وتدفق الترافيك",duration:"70 دقيقة",summary:"ميّز حدود الشبكة ومساراتها، وافهم لماذا يحتاج East-West إلى تقسيم ومراقبة مثل North-South.",
        lessons:[
      ...
      {
        id:"pa-06",title:"معمارية NGFW والسياسات",duration:"85 دقيقة",summary:"اربط App-ID وUser-ID وContent-ID بسياسة مبنية على التطبيق والهوية والمحتوى بدل الاعتماد على Ports.",
        lessons:[
      ...
      {
        id:"pa-07",title:"Threat Prevention وDNS Security",duration:"80 دقيقة",summary:"اختر طبقات الحماية المناسبة للتهديد واقرأ السجل الذي يثبت المنع أو الكشف.",
        lessons:[
      ...
      {
        id:"pa-08",title:"هجمات الشبكة والحماية",duration:"75 دقيقة",summary:"اربط Spoofing وDoS وتهديدات Layer 2 وRouting بالضابط الأنسب وطريقة التحقق.",
        lessons:[
      ...
      {
        id:"pa-09",title:"Logging وCLI والتشخيص",duration:"85 دقيقة",summary:"اتبع مسار Packet من المصدر إلى الوجهة واقرأ Traffic وThreat وSystem Logs بدل التخمين.",
        lessons:[
      ...
      {
        id:"pa-10",title:"مشروع ختامي ومراجعة",duration:"90 دقيقة",summary:"اجمع الشبكات والسياسات والحماية والسجلات في تصميم واحد قابل للشرح والاختبار.",
        lessons:[
  ...
  {
    id:"f5-big-ip",code:"F5",accent:"cyan",title:"F5 BIG-IP 17.1.x",subtitle:"From Foundations to Application Delivery",arTitle:"دورة F5 BIG-IP",level:"مبتدئ إلى متقدم",duration:"18 ساعة",
    ...
    modules:[
      {id:"f5-01",title:"ADC وFull Proxy وTMOS",duration:"80 دقيقة",summary:"افهم مكان BIG-IP في مسار التطبيق ولماذا يبني اتصالين مستقلين بدل تمرير Packet فقط.",lessons:[
      ...
      {id:"f5-02",title:"الإعداد الأولي وNetwork Objects",duration:"90 دقيقة",summary:"ابنِ الأساس: Management وVLAN وSelf IP وRoute وPartition قبل إنشاء خدمة LTM.",lessons:[
      ...
      {id:"f5-03",title:"LTM: Nodes وPools وVirtual Servers",duration:"95 دقيقة",summary:"أتقن الكائنات الأساسية ورحلة الطلب من Listener حتى اختيار Pool Member.",lessons:[
      ...
      {id:"f5-04",title:"Monitors وLoad Balancing وPersistence وSNAT",duration:"110 دقيقة",summary:"اضبط اختيار الخادم واستمرارية الجلسة ومسار العودة دون صنع اختناقات مخفية.",lessons:[
      ...
      {id:"f5-05",title:"Profiles وSSL وiRules وPolicies",duration:"115 دقيقة",summary:"تحكم في سلوك TCP وHTTP وTLS وأضف منطقًا قابلًا للصيانة عند الحاجة فقط.",lessons:[
      ...
      {id:"f5-06",title:"High Availability وDSC",duration:"95 دقيقة",summary:"افهم Device Trust وConfig Sync وFailover وTraffic Groups، ثم اختبر التعافي لا مجرد حالة Green.",lessons:[
      ...
      {id:"f5-07",title:"BIG-IP DNS وGSLB",duration:"90 دقيقة",summary:"وزّع المستخدمين بين المواقع بناءً على الصحة والسياسة بدل DNS ثابت.",lessons:[
      ...
      {id:"f5-08",title:"Advanced WAF وAPM وAFM",duration:"120 دقيقة",summary:"ميّز أدوار حماية التطبيق والهوية وجدار الشبكة، واربطها في مسار طلب واحد.",lessons:[
      ...
      {id:"f5-09",title:"TMSH وREST والأتمتة والVisibility",duration:"100 دقيقة",summary:"أدر BIG-IP بشكل قابل للتكرار وراقب النظام والتطبيق بدل التغييرات اليدوية غير الموثقة.",lessons:[
      ...
      {id:"f5-10",title:"Troubleshooting ومشروع ختامي",duration:"120 دقيقة",summary:"حوّل الأعراض إلى طبقة وأداة، ثم ابنِ خدمة آمنة وعالية التوافر واختبر حالات الفشل.",lessons:[
